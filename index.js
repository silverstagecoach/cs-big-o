...
// ANSWER: No, this is pretty simple as it is. Not only is it perfectly functional as a block of code, but it takes up very little time/space.
...
// ANSWER: 
// function dontTouchMySalad(numbers) {
//   numbers.map((item) => item * item)
//   return numbers
// }
...
// ANSWER: It depends on the string that's passed in. If they got a string of the same length, it would take the same space to solve.
